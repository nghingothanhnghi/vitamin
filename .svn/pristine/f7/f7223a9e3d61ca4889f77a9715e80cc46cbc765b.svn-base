...
@Component({
  selector: 'app-order-mileage-inquiry',
  templateUrl: './order-mileage-inquiry.component.html',
  styleUrls: ['./order-mileage-inquiry.component.css']
})
export class OrderMileageInquiryComponent implements OnInit {
  page: number = 1;
  len: number = 10;
