...
import { NowApielgoModel } from '@app/models/homepage/media-center/now-apielgo.model';
...
@Component({
  selector: 'app-now-apielgo',
  templateUrl: './now-apielgo.component.html',
  styleUrls: ['./now-apielgo.component.css',
    './../../../../assets/css/home/media-center.css' 
  ]
})
export class NowApielgoComponent implements OnInit {
  ...
  handleOnClickBoardNo(boardNo: String): void {
    ...
    this.router.navigate(['/servicePage/now-apielgo-detail']);
  }
