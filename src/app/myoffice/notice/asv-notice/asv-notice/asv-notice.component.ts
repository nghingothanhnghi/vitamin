...
@Component({
  selector: 'app-asv-notice',
  templateUrl: './asv-notice.component.html',
  styleUrls: ['./asv-notice.component.css']
})
export class AsvNoticeComponent implements OnInit {
  ...
  handleOnClickBoardNo(boardNo: String): void {
    ...
    this.router.navigate(['/serviceCenter/asv-notice-detail']);
  }
