...
@Component({
  selector: 'ado-paymemnt',
  templateUrl: './ado-paymemnt.component.html',
  styleUrls: ['./ado-paymemnt.component.css']
})
export class AdoPaymemntComponent implements OnInit, OnChanges {
